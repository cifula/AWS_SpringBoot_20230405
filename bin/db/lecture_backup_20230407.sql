...
/*!40014 SET @OLD_FOREIGN_KEY_CHECKS=@lectuer_registe_mstlectuer_registe_mst@FOREIGN_KEY_CHECKS, FOREIGN_KEY_CHECKS=0 */;
/*!40101 SET @OLD_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO' */;
/*!40111 SET @OLD_SQL_NOTES=@@SQL_NOTES, SQL_NOTES=0 */;

--
-- Table structure for table `lectuer_registe_mst`
--

DROP TABLE IF EXISTS `lectuer_registe_mst`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `lectuer_registe_mst` (
...
--
-- Dumping data for table `lectuer_registe_mst`
--

LOCK TABLES `lectuer_registe_mst` WRITE;
/*!40000 ALTER TABLE `lectuer_registe_mst` DISABLE KEYS */;
/*!40000 ALTER TABLE `lectuer_registe_mst` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `lecture_mst` VALUES (1,'java기초',50000,1),(2,'java기초',50000,1),(3,'java기초',50000,1),(4,'java기초',50000,2),(5,'java기초',50000,3);
...
-- Dump completed on 2023-04-07 17:47:36
